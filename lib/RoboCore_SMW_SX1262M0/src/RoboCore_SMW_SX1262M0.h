...
#define SMW_SX1262M0_TX_STATUS_NOT_CONFIRMED 0
#define SMW_SX1262M0_TX_STATUS_CONFIRMED     1
...
class SMW_SX1262M0 {
  public:
    ...
    CommandResponse get_CFM(uint8_t (&));
    ...
    CommandResponse get_ConfStatus(uint8_t (&));
    ...
    CommandResponse set_CFM(uint8_t);
